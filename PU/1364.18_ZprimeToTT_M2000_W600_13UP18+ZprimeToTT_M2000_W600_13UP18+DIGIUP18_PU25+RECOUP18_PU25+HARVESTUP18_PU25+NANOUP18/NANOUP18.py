...
# with command line options: step5 --conditions auto:phase1_2018_realistic --nThreads 2 -n 10 --era Run2_2018 --eventcontent NANOEDMAODSIM --filein file:step3_inMINIAODSIM.root -s NANO --datatier NANOAODSIM --mc --io NANOUP18.io --python NANOUP18.py --no_exec --fileout file:step5.root --nThreads 4
