...
# with command line options: Configuration/Generator/python/ZprimeToTT_M2000_W600_13TeV_cfi.py --conditions auto:phase1_2018_realistic -n 10 --era Run2_2018 --eventcontent FEVTDEBUG,LHE --relval 9000,100 -s LHE,GEN,SIM --datatier GEN-SIM,LHE --beamspot Realistic25ns13TeVEarly2018Collision --geometry DB:Extended --io ZprimeToTT_M2000_W600_13UP18.io --python ZprimeToTT_M2000_W600_13UP18.py --no_exec --fileout file:step1.root --nThreads 4
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/Generator/python/ZprimeToTT_M2000_W600_13TeV_cfi.py nevts:10'),
