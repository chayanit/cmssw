...
# with command line options: step3 --conditions auto:phase1_2018_realistic --pileup_input das:/RelValMinBias_13/CMSSW_11_2_0_pre6-112X_upgrade2018_realistic_v3-v1/GEN-SIM -n 10 --era Run2_2018 --eventcontent RECOSIM,MINIAODSIM,DQM -s RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT,VALIDATION:@standardValidationNoHLT+@miniAODValidation,DQM:@standardDQMFakeHLT+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --pileup 2018_25ns_UltraLegacy_PoissonOOTPU --geometry DB:Extended --io RECOUP18_PU25.io --python RECOUP18_PU25.py --no_exec --filein file:step2.root --fileout file:step3.root --nThreads 4
