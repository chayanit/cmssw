...
# with command line options: step5 --conditions auto:phase1_2018_realistic -n 10 --era Run2_2018 --eventcontent NANOEDMAODSIM --filein file:step3_inMINIAODSIM.root -s NANO --datatier NANOAODSIM --geometry DB:Extended --io Nano_2018PU.io --python Nano_2018PU.py --no_exec --fileout file:step5.root --nThreads 4
