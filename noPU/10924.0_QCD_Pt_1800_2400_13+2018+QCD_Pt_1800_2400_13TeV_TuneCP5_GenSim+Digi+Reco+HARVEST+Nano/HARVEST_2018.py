...
# with command line options: step4 --conditions auto:phase1_2018_realistic -s HARVESTING:@standardValidation+@standardDQM+@ExtraHLT+@miniAODValidation+@miniAODDQM --scenario pp --filetype DQM --geometry DB:Extended --era Run2_2018 --mc --io HARVEST_2018.io --python HARVEST_2018.py -n 100 --no_exec --filein file:step3_inDQM.root --fileout file:step4.root
