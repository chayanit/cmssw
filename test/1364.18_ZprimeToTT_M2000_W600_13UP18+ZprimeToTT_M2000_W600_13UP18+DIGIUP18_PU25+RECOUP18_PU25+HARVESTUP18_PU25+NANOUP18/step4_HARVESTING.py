...
# with command line options: step4 --conditions auto:phase1_2018_realistic -s HARVESTING:@standardValidationNoHLT+@standardDQMFakeHLT+@miniAODValidation+@miniAODDQM --scenario pp --filetype DQM --geometry DB:Extended --era Run2_2018 --mc -n 5 --filein file:step3_inDQM.root --fileout file:step4.root
