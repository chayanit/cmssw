...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/Generator/python/ZprimeToTT_M2000_W600_13TeV_cfi.py nevts:5'),
